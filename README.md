...
- **[Beamable](https://beamable.com)** :zap:
Beamable enables game makers to easily add social, commerce and content management features to their games with drag-and-drop prefabs inside Unity without the need of a server. A unity package features ready-to-ship user interfaces distilled from best-practices with every feature, and a visual skinning designer so they seamlessly integrate with the developer's game. A fully managed SaaS backend powers Beamable with features including Accounts, Social Login, Groups/Guilds/Teams, Chat, Friends, Leaderboards, Live Events, In-Game Mail, Push Notifications, News/Announcements, Analytics, Segmentation, Stats/User Properties, Commerce/Storefront, Payments (Steam, Windows Store, iOS, Google Play, Amazon, Facebook/Gameroom, Flexion), Inventory, and a Relay Server for deterministic real-time multiplayer and turn-based multiplayer. 
...
Swrve is an integrated mobile marketing platform, used by some of the world's leading app businesses to drive retention, engagement and revenue on mobile. The Swrve platform supports both in-depth analytics and highly sophisticated push campaigns, in addition to rich in-app messaging support and a/b testing of the native mobile environment. As a result the platform is able to deliver more personal, relevant and effective campaigns than previously possible in mobile - and deliver the metrics to match.
