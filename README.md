...
commercetools is a cloud-based platform for commerce applications. Developers can build any kind of frontend application (web, native, etc.) on top of a well-documented REST API and have access to various ready-made SDKs and templates.
